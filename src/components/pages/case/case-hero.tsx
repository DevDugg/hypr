...
const CaseHero = () => {
  return (
    <div>
      <section className="bg-case-pattern bg-cover h-screen flex flex-col justify-end bg-top bg-no-repeat text-WHITE mb-[3.12vw]">
        <Container className="size80 uppercase font-bold">
          project name
        </Container>
      </section>
