          ...
          {keys.map(
            (item, i) =>
              i === active && (
                <motion.div
                  key={i}
                  initial={{ height: 0, zIndex: 5, transformOrigin: 'top' }}
                  animate={{ height: '25vw', zIndex: 10, transformOrigin: 'bottom' }}
                  exit={{ height: 0, zIndex: 5, transformOrigin: 'bottom' }}
          ...
          <div className="flex flex-col gap-[4vw]">
            <div className="flex text-GRAY gap-[1.25vw] font-medium leading-[140%] size18 w-full">
              <p className="size18 flex-[1_0_24.53vw]">
                HYPR agency is a branding and digital marketing studio from Australia. Partnering
                with companies that need to transform their brand, attract the right audience, and
                radically stand out. We’re a nimble team of designers and creative developers,
                focused on creating uniquely human and culturally informed. Read more
              </p>
