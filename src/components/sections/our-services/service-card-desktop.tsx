...
export const ServiceCardDesktop = ({ title, i, activeItem, img }: IProps) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <Image src={img} width={256} height={320} alt="service image" className="size-full w-1/2 object-cover" />
      </motion.div>
    </div>
  );
};
